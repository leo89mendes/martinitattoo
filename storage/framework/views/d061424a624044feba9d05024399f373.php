<div class="container-xl mx-auto h-[700px] text-white" style="font-family:'Hepta Slab'">
    ...
    <a id="top" href="#totop" class="hidden btn_top fixed bottom-[2rem] right-[2rem] bg-black hover:bg-[#1cdfbc] z-10 rounded-full p-1">
        ...
        <div class="arrow absolute top-[22px] left-[20px]">
    ...
    <header>
        <nav class="menu cursor-pointer hidden md:grid grid-cols-5 py-[1.5rem] md:px-[13rem] text-[0.8rem]">
            ...
            <div class="flex justify-center">
                <a href="<?php echo e(url('/')); ?>"><img class="rounded-[25px] md:h-full h-[100px]" src="<?php echo e(asset('storage/' . $setting[0]->logo)); ?>" alt=""></a>
            </div>
            <div class="px-4 grid grid-cols-3 col-span-2 gap-2 text-center items-center font-semibold uppercase">
                ...
                <a class='border-2 border-black col-span-2 text-black px-4 py-4 hover:ring-2 hover:ring-offset-2  bg-[#1cdfbc] rounded-[4rem]' href="https://wa.me/<?php echo e($setting[0]->telephone); ?>" target="_blank">
                    FAÇA UM ORÇAMENTO
                </a> 
            </div>
        </nav>
        ...
        <div class="flex md:hidden justify-center">
            <a href="<?php echo e(url('/')); ?>"><img class="rounded-[25px] h-[150px] my-4" src="<?php echo e(asset('storage/' . $setting[0]->logo)); ?>" alt=""></a>
        </div>
        <div x-data="{open: false}">
            ...
            <div x-show="open" 
                x-transition:enter="transition ease-in duration-6000"
                x-transition:enter-start="opacity-0"
                x-transition:enter-end="opacity-100"
                x-transition:leave="transition ease-in duration-300"
                x-transition:leave-start="opacity-100"
                x-transition:leave-end="opacity-0"
                id="drawer-navigation" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto  bg-black w-64 dark:bg-gray-800">
                <h5 id="drawer-navigation-label" class="text-base font-semibold text-white uppercase">Menu</h5>
                <button type="button" class="closeButton text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white" >
                    <svg x-on:click="open = !open" class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
    ...
    <div id="banner" class="mySwiper">
        <div class="swiper-wrapper">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div id="banner-<?php echo e($k+1); ?>" class="swiper-slide">
                    <div id="slide<?php echo e($k); ?>" class="overflow-hidden justify-center flex flex-col h-[500px] w-full md:py-[8rem] md:pr-[5rem] text-center bg-no-repeat bg-cover" style="background-image: url(<?php echo e(asset('storage/' . $banner['img'])); ?>);">
                        <div class="msg_banner<?php echo e($k); ?> py-10 px-5">
                            <h2 class="text-[4rem]"><?php echo e($banner['title']); ?></h2>
                            <h4><?php echo $banner['subtitle']; ?></h4>
                            <div class="flex justify-center text-[1rem] ">
                                <a href="https://wa.me/<?php echo e($setting[0]->telephone); ?>" class='hover:border-2 hover:border-black hover:ring-2 hover:ring-offset-2  text-black h-[60px]  p-4 mt-4 bg-[#1cdfbc] rounded-[4rem]'>
                                    <?php echo e($banner['btn_text']); ?>
    ...
    <section id="about" class="bg-black md:px-8 flex flex-col md:flex-row md:text-left text-center gap-4 md:my-[100px] my-[50px]">
        <div class="about_me flex flex-col md:items-start items-center justify-center px-8 md:py-0 py-8 md:w-5/12">
            <h1 class=" font-medium text-[2.8rem] mb-4"><?php echo e($aboutme[0]['title']); ?></h1>
            <div><?php echo $aboutme[0]['description']; ?></div>
            <div class='cursor-pointer hover:ring-2 hover:ring-offset-2 border-2 max-w-[13.5rem] border-black text-black p-4 mt-4 bg-[#1cdfbc] rounded-[4rem]'>
                <a href="https://wa.me/<?php echo e($setting[0]->telephone); ?>" target="_blank">
                    <?php echo e($aboutme[0]['btn_text']); ?>

                </a> 
            </div>
        </div>
        <div class="pb-[20px] md:h-[350px] h-[250px] md:px-0 px-4 block md:w-7/12">
            <iframe class="grayscale hover:grayscale-0 rounded-[25px] block" width="100%" height="100%" src="<?php echo e($aboutme[0]['link_video']); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
    <section class="md:flex hidden  video_background bg-no-repeat bg-cover bg-center md:h-[600px] h-[350px]  items-center justify-center w-full md:text-left text-center md:my-[100px] my-[50px]">
        <iframe class="grayscale hover:grayscale-0 flex" width="100%" height="100%" src="<?php echo e($video[0]['link']); ?>" controls="0" autoplay="1" title="YouTube video player" frameborder="0"  allow="autoplay;" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
            <button>
...
[$__name, $__params] = $__split('instagram-gallery', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1542304661-0', $__slots ?? [], get_defined_vars());
...
?>
    <section class="testimonials bg-no-repeat bg-cover bg-center contact flex flex-col justify-center w-full md:text-left text-center md:my-[100px] my-[50px] py-8" style="background-image: url(<?php echo e(asset('storage/assets/img/bg_testimonials.jpg')); ?>)">
        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <div class="py-4 flex justify-center align-center gap-4">
                            <div class="testimonial-image max-w-[5rem]">
                                <img class="cover rounded-full" src="<?php echo e(asset('storage/' . $testi->image)); ?>" loading="lazy">
                                <div class="swiper-lazy-preloader"></div>
                            </div>
                            <cite class="flex flex-col justify-center items-center">
                                <p class="testimonial-author text-[#9f9f9f]"><?php echo e($testi->name); ?></p>
                                <span><?php echo e($testi->position); ?></span>
                            </cite>
                        </div>
    ...
    <section id="contact" class="contact flex flex-col md:flex-row md:my-[100px] my-[50px] md:px-8 px-4">
        <div class="py-8 flex flex-col items-center justify-center md:w-6/12">
            <ul class="address-blocks list-unstyled px-4">
                <li> 
                    <button class="address hover:text-[#1cdfbc] inline-flex items-center my-4" data-iframe="true" id="open-google-map" data-src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3656.1803613613147!2d-46.6895369888331!3d-23.597863678686167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce57490ff63011%3A0x5872138c085ee0da!2sAlameda%20Vicente%20Pinzon%2C%20257%20-%20Itaim%20Bibi%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2004547-130!5e0!3m2!1sen!2sbr!4v1730508848844!5m2!1sen!2sbr">
                        ...
                        <div class="details-wrapper text-left">  
                            ...
                            <address><?php echo e($setting[0]->address); ?></address>
                        </div>
                    </button>
                </li>
                <li>
                    <a class="address hover:text-[#1cdfbc] inline-flex items-center my-4" href="mailto:<?php echo e($setting[0]->email); ?>@martinitattoo.com">
                        <span class="contact-icons  text-[#1cdfbc] px-8">
                            <svg width="35" height="35" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="details-wrapper">  
                            ...
                            <span><?php echo e($setting[0]->email); ?>@martinitattoo.com</span>
                        </div> 
                    </a>   
                </li>
                <li>   
                    <a target="_blank" class="phone hover:text-[#1cdfbc] inline-flex items-center my-4" href="https://wa.me/<?php echo e($setting[0]->telephone); ?>">
                        <span class="contact-icons text-[#1cdfbc] px-8">
                            <svg width="35" height="35" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="details-wrapper">  
                            ...
                            +55 <?php echo e($setting[0]->telephone); ?>
    ...
    <section class="footer flex flex-col justify-center items-center text-center md:text-left bg-cover bg-no-repeat w-full" style="background-image: url(<?php echo e(asset('storage/assets/img/bg_footer.png')); ?>)">
        <div class="flex flex-col items-center gap-4 py-8">
            <img class="rounded-[25px] h-[160px]" src="<?php echo e(asset('storage/' . $setting[0]->logo)); ?>" alt=""> 
            ...
            <ul class="list-social inline-flex gap-4" role="list">
                <!--[if BLOCK]><![endif]--><?php if($setting[0]['twitter'] != ''): ?>
                <li class="list-social__item">
                    <a target="_blank" href="https://twitter.com/<?php echo e($setting[0]['twitter']); ?>" class="link text-social__link hover:text-[#1cdfbc]">
                ...
                <!--[if BLOCK]><![endif]--><?php if($setting[0]['facebook'] != ''): ?>
                <li class="list-social__item">
                    <a target="_blank" href="https://www.facebook.com/<?php echo e($setting[0]['facebook']); ?>" class="link text-social__link hover:text-[#1cdfbc]">
                ...
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($setting[0]['instagram'] != ''): ?>
                <li class="list-social__item">
                    <a target="_blank" href="https://www.instagram.com/<?php echo e($setting[0]['instagram']); ?>" class="link text-social__link hover:text-[#1cdfbc]">
                ...
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($setting[0]['youtube'] != ''): ?>
                <li class="list-social__item">
                    <a target="_blank" href="https://www.youtube.com/<?php echo e($setting[0]['youtube']); ?>" class="link text-social__link hover:text-[#1cdfbc]">
...
<?php /**PATH /var/www/html/resources/views/livewire/home.blade.php ENDPATH**/ ?>