<div class="container-xl mx-auto h-[700px] text-white" style="font-family:'Hepta Slab'">
    ...
    <section class="footer flex justify-center items-center py-8 text-center md:text-left bg-cover bg-no-repeat w-full" style="background-image: url({{ asset('storage/assets/img/bg_footer.png') }})">
